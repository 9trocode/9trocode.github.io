...
<section class="hero">
 ...
 <p class="hero__lede">Platforms, multi-tenant isolation, agent sandboxes, deploy paths that have to stay up. If that sounds like your kind of problem, pull up a chair - I write down what actually happened.</p>
 <ul class="hero__meta">
 <li>PipeOps</li>
 <li>Igris</li>
 <li>Rexec</li>
